...
{
    public class MapView : Control, IMapViewport, IItemRenderStyleProvider
    {
        ...
        {
            Zoom(newZoomLevel, new Point(Width / 2, Height / 2));
        }
        ...
        {
            CurrentTool?.OnMouseMove(e, ModifierKeys, CreateMapToolContext());
            base.OnMouseMove(e);
        }
